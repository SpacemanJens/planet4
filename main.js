...
function preload() {
//  sunTexture = loadImage('images/bgDog3.png');
 // sunTexture = loadImage('images/alienPlanetP1DoubleV3.png');
  sunTexture = loadImage('images/alienPlanetP1V3Small.jpeg');
//  sunTexture = loadImage('images/alienPlanetP1DoubleV3cleaned.png');
...
function setup() {
  ...
  cam = createEasyCam({ distance: 200 });

  sun = new Planet(30, 0, 0, sunTexture);
  //sun.spawnMoons(4, 1);
}
